...
const appendCat = (name) => { return [...cats, name] }
const prependCat = (name) => { return [name, ...cats] }
const removeLastCat = (name) => { return cats.slice(0, -1) }
const removeFirstCat = (name) => { return cats.slice(1) }
